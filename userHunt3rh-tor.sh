...
function userattack()
  {
      ...
      echo
      service tor restart
      torify userrecon-py target $useracc
      read -p "Press [Enter] to continue..."
      echo
      service tor restart
      echo
      ...
      echo
      read -p "Press [Enter] to continue..."
      torify python3 sherlock/sherlock/sherlock.py  $useracc
      sleep 5
      read -p "Press [Enter] to continue..."
      echo 
...
function domianattack()
 {
      ...
      # User input:
      echo
      echo -e "\e[40;38;5;82m  [-] \e[30;48;5;82m Setup Domain Emails Leaked  !!!  \e[0m"
      sleep 2s
      echo
      echo "Please enter Domain : example @gmail.com "
      read domacc
      torify python3 pwndb/pwndb.py --target $domacc
      echo
      read -p "Press [Enter] to continue..."
      echo
 }
